...
pickle_in = open("C:/Users/Purushothama G V/Documents/Deplyoment/model_df_smott.pkl","rb")
...
def Churn_prediction(account_length,voice_plan,voice_messages,intl_plan,intl_mins,intl_calls,intl_charge,day_mins,day_calls,day_charge,eve_mins,eve_calls,eve_charge,night_mins,night_calls,night_charge,customer_calls,churn):
    ...
    prediction=model_df_smott.predict([[account_length,voice_plan,voice_messages,intl_plan,intl_mins,intl_calls,intl_charge,day_mins,day_calls,day_charge,eve_mins,eve_calls,eve_charge,night_mins,night_calls,night_charge,customer_calls,churn]])
    print(prediction)
    if (prediction[0] == 0):
